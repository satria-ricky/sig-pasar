        ...
        <div class="panel-header bg-primary-gradient">
          <div class="page-inner py-5">
            ...
            <div class="page-header text-white">
              ...
              <input type="hidden" id="id_sales" value="<?= $data_detail['user_id'];?>">
              <ul class="breadcrumbs">
                ...
                <li class="nav-item">
                  <a href="#" class="text-white">Detail sales</a>
                </li>
              </ul>
            </div>
                ...
                <div class="card-body">
                  <div class="d-flex flex-column align-items-center text-center">
                    ...
                    <div class="mt-3">
                      ...
                      <p class="text-muted font-size-sm">Akun dibuat pada : <?= $data_detail['user_created'];?></p>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="card-body">
                  ...
                  <hr>
                   <div class="row">
                    ...
                    <div class="col-sm-9 text-secondary">
                      <?php if ($data_detail['user_id_status'] == '1'){ ?>
                  ...
                  <div class="row">
                    <div class="col-sm-12">
                      <?php
                        ...
                        $link = $data_pengguna['level_nama']."/edit_sales/".$enc;
                       ?>
                      <a class="btn btn-info " target="" href="<?= base_url("$link");?>">Edit sales</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header">
                  <h4 class="card-title"><b>Riwayat Kerja : <?= $data_detail['user_nama'];?></b></h4>
                </div>
                <div class="card-header">
...
<button id="button_pdf" class="btn btn-danger" >Export to PDF</button> 
                    ...
                    "columns": [
                        ...
                        { 
                            ...
                            return `
                              ...
                              <button class="btn btn-success btn-xs btn-round m-0" onclick="edit(${row.main_id})">Edit</button>
...
function hapus(id) {
  ...
  function edit(id){ 
    document.location.href = "<?php echo base_url('admin/editpas_riwayat_sales/')?>"+id;
  }
...
$(document).ready(function(){
        ...
        $('#button_pdf').on('click', function (e) {
           // console.log($('#tanggal1').val());
            var sales = document.getElementById('id_sales').value;
            var tanggal1 = $('#tanggal1').val();
            var tanggal2 = $('#tanggal2').val();
            ...
            var id_toko = $('#toko_select').val();
            if (tanggal1 == "" || tanggal2 == "") {
              swal("Silahkan filter data terlebih dahulu!", {
                  icon : "error",
                  buttons: {                  
                      confirm: {
                          className : 'btn btn-danger'
