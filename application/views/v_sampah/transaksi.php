        ...
        <div class="panel-header bg-primary-gradient">
          <div class="page-inner py-5">
            ...
            <div class="page-header text-white">
              <h4 class="page-title text-white">Sampah</h4>
...
<script type="text/javascript">
  ...
  function getmain(sales,tanggal1,tanggal2,rute,toko){
    ...
    $.ajax({
            url: "<?php echo base_url(); ?>auth/get_sampah_transaksi",
            type: "post",
            data: {
                id_sales : sales,
                tanggal1 : tanggal1,
                    ...
                    "columns": [
                        ...
                        },
                        {
                            ...
                            return `
                              ...
                              <button class="btn btn-success btn-xs btn-round" onclick="edit(${row.main_id})">Pulihkan</button>
                              <button class="btn btn-danger btn-xs btn-round" onclick="hapus(${row.main_id})">Hapus permanen </button>  
                              `;
                            }
                        }
                      ],
                      ...
                      "footerCallback": function ( row, data, start, end, display ) {
                        ...
                        $( api.column( 8 ).footer()).html('Rp. '+sepray_total.toLocaleString());
                        $( api.column( 9 ).footer()).html('Rp. '+roll_total.toLocaleString());
                        $( api.column( 10 ).footer()).html(bonus_sepray_total);
                        $( api.column( 11 ).footer()).html(bonus_roll_total);
                    }  
            ...
            if (Pulihkan) {
              swal({
                ...
                if (yess) {
                  $.ajax({
                    method: 'post',
                    url: "<?php echo base_url(); ?>auth/pulihkan",
                    data: {
                        id: id
                    },
                    dataType: "json",
            ...
            if (Delete) {
              swal({
                ...
                if (Hapus) {
                  $.ajax({
                    method: 'post',
                    url: "<?php echo base_url(); ?>auth/hapus_riwayat",
                    data: {
                        id: id
                    },
                    dataType: "json",
